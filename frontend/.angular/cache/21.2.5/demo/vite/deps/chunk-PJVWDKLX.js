...
var immediateProvider = {
  setImmediate: function () {
    ...
    return (
      (delegate === null || delegate === void 0 ? void 0 : delegate.setImmediate) || setImmediate
    ).apply(void 0, __spreadArray([], __read(args)));
  },
  clearImmediate: function (handle) {
    var delegate = immediateProvider.delegate;
    return (
      (delegate === null || delegate === void 0 ? void 0 : delegate.clearImmediate) ||
      clearImmediate
    )(handle);
  },
  delegate: void 0,
...
function isObservable(obj) {
  return (
    !!obj && (obj instanceof Observable || (isFunction(obj.lift) && isFunction(obj.subscribe)))
  );
}
...
function timeout(config2, schedulerArg) {
  ...
  return operate(function (source, subscriber) {
    ...
    !seen &&
      startTimer(
        first2 != null ? (typeof first2 === 'number' ? first2 : +first2 - scheduler.now()) : each
      );
  });
}
        ...
        source.subscribe(
          createOperatorSubscriber(
            ...
            function () {
              ...
              try {
                for (
                  var buffer_1 = __values(buffer2), buffer_1_1 = buffer_1.next();
                  !buffer_1_1.done;
      ...
      createOperatorSubscriber(
        ...
        function () {
          if (hasValue) {
            ...
            subscriber.error(
              seenValue ? new NotFoundError('No matching values') : new EmptyError()
            );
          }
        }
      )
        ...
        function (openValue) {
          ...
          closingSubscription.add(
            closingNotifier.subscribe(
              createOperatorSubscriber(subscriber, closeWindow, noop, handleError)
            )
          );
        },
        noop
